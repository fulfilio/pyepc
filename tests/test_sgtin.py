...
def test_sgtin_96_invalid_serial():
    ...
    assert (
        sgtin.get_tag_uri(binary_scheme=SGTIN.BinarySchemes.SGTIN_198)
...
def test_sgtin_198():
    ...
    assert (
        sgtin.encode(binary_scheme=SGTIN.BinarySchemes.SGTIN_198)
        == "3634257BF7194E5B3770E40000000000000000000000000000"
    )
    assert SGTIN.decode("3634257BF7194E5B3770E40000000000000000000000000000") == sgtin
...
def test_sgtin_198_alpha_num_serial():
    ...
    assert SGTIN.decode("3634257BF7194E5B3770E60C20000000000000000000000000") == sgtin
